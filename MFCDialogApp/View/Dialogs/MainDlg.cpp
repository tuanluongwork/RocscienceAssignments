...
BOOL CMainDlg::OnInitDialog()
{
    ...
    try {
        ...
        TRACE("Exception in CMainDlg::OnInitDialog: %s\n", e.what());
    }
...
void CMainDlg::UpdateUI()
{
    try {
        ...
        TRACE("Exception in CMainDlg::UpdateUI: %s\n", e.what());
    }
}
...
void CMainDlg::OnBnClickedButton1()
{
    try {
        ...
        TRACE("Exception in CMainDlg::OnBnClickedButton1: %s\n", e.what());
        AfxMessageBox(L"An error occurred while showing the Ground Water dialog.", MB_ICONERROR);
    }
}
...
void CMainDlg::OnBnClickedButton2()
{
    try {
        ...
        TRACE("Exception in CMainDlg::OnBnClickedButton2: %s\n", e.what());
        AfxMessageBox(L"An error occurred while showing the Thermal dialog.", MB_ICONERROR);
    }
}